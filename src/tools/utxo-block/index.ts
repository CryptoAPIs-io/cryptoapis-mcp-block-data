...
import { UtxoBlockToolSchema, type UtxoBlockInput } from "./schema.js";
...
export const utxoBlockTool: McpToolDef<typeof UtxoBlockToolSchema> = {
    name: "utxo_block_data",
    description: `Get UTXO block details (Block Data product).
...
${UTXO_BLOCKCHAIN_NETWORK_DESCRIPTION}`,
    ...
    inputSchema: UtxoBlockToolSchema,
    handler:
        (client: CryptoApisHttpClient, logger: McpLogger) =>
        async (input: UtxoBlockInput) => {
...
export { UtxoBlockToolSchema, type UtxoBlockInput } from "./schema.js";
